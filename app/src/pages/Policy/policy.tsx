    ...
    <>
      ...
      <Typography>
        <p>
          ...
          предпринимаемые КК Авангард (далее — Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта https://kk-a.ru. 2.
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://kk-a.ru.
        </p>
        <p>
        ...
        <p>2.10. Пользователь — любой посетитель веб-сайта https://kk-a.ru.</p>
        <p>
        ...
        <p>
          4. Основные права и обязанности субъектов персональных данных 4.1.
        ...
        <p>
          ...
          содержащимся на веб-сайте Персональные данные фамилия, имя, отчество
          номера телефонов год, месяц, дата и место рождения фотографии адрес
          фактического места проживания и регистрации по месту жительства и/или
          по месту пребывания сведения об образовании, профессии, специальности
          и квалификации, реквизиты документов об образовании сведения о
          семейном положении и составе семьи Правовые основания договоры,
          заключаемые между оператором и субъектом персональных данных Виды
          обработки персональных данных Сбор, запись, систематизация,
        ...
        <p>
          ...
          bogus077@gmail.com с пометкой «Актуализация персональных данных».
        </p>{' '}
        <p>
          ...
          на электронный адрес Оператора bogus077@gmail.com с пометкой «Отзыв
        ...
        <p>
          10. Трансграничная передача персональных данных 10.1. Оператор до
        ...
        <p>
          ...
          сети Интернет по адресу https://kk-a.ru/policy.
        </p>
      </Typography>
    </>
  );
